...
class Admin_dashboard extends CI_Controller {	
    ...
    public function index(){
	    ...
	    $total_proforma_invoice = 	$CI->Invoices->count_proforma();
	    ...
	    $mr_total_sales             =   $CI->Invoices->mr_total_sales();
	    $mr_total_proforma_invoice  =   $CI->Invoices->mr_total_proforma_invoice();
	    $customer_total_purchase    =   $CI->Invoices->customer_total_purchase();
	    
	    $total_sales_amount                 =   $CI->Invoices->total_sales_amount();
	    $total_proforma_invoice_amount      =   $CI->Invoices->total_proforma_invoice_amount();
	    $customer_total_proforma_invoice    =   $CI->Invoices->customer_total_proforma_invoice();
	    
	    
	    $total_demand_request 			=	$CI->Invoices->total_demand_request();
	    $total_approve_demand_request 	=	$CI->Invoices->total_approve_demand_request();
	    $total_pending_demand_request   =	$CI->Invoices->total_pending_demand_request();
	    
	    $total_cust_demand_request 			=	$CI->Invoices->total_cust_demand_request();
	    $total_cust_approve_demand_request 	=	$CI->Invoices->total_cust_approve_demand_request();
	    $total_cust_pending_demand_request   =	$CI->Invoices->total_cust_pending_demand_request();

		$total_payment_received_from_client =	$CI->Mrs->total_payment_received_from_client();
		$total_payment_received_from_mr 	=	$CI->Mrs->total_payment_received_from_mr();
		$total_expenses_of_mr_pending 		=	$CI->Mrs->total_expenses_of_mr('Pending');
		$total_expenses_of_mr_rejected 		=	$CI->Mrs->total_expenses_of_mr('Rejected');
		$total_expenses_of_mr 				=	$CI->Mrs->total_expenses_of_mr('Approved');

		$total_salary_of_mr 				=	$CI->Mrs->total_salary_of_mr();
	    ...
	    $data = array(
	    	...
	    	'total_proforma_invoice'    =>  $total_proforma_invoice,
	    	'mr_total_sales'            =>  $mr_total_sales,
	    	'mr_total_proforma_invoice'            =>  $mr_total_proforma_invoice,
	    	'customer_total_purchase'   =>  $customer_total_purchase,
	    	'customer_total_proforma_invoice' => $customer_total_proforma_invoice,
	    	'total_sales_amount'        =>  $total_sales_amount,
	    	'total_proforma_invoice_amount' => $total_proforma_invoice_amount,
	    	
	    	'total_demand_request'          =>  $total_demand_request,
	    	'total_approve_demand_request'  =>  $total_approve_demand_request,
	    	'total_pending_demand_request'  =>  $total_pending_demand_request,
	    	'total_cust_demand_request'          =>  $total_cust_demand_request,
	    	'total_cust_approve_demand_request'  =>  $total_cust_approve_demand_request,
	    	'total_cust_pending_demand_request'  =>  $total_cust_pending_demand_request,

			'total_payment_received_from_client'  =>  $total_payment_received_from_client,
	    	'total_payment_received_from_mr'  =>  $total_payment_received_from_mr,
			'total_expenses_of_mr_pending'  =>  $total_expenses_of_mr_pending,
			'total_expenses_of_mr_rejected'  =>  $total_expenses_of_mr_rejected,
			'total_expenses_of_mr'  =>  $total_expenses_of_mr,
	    	'total_salary_of_mr'  =>  $total_salary_of_mr,
	...
	{	
		...
		elseif($email != $this->session->userdata('user_email')){
		...
		elseif($CI->Users->change_password($email,$old_password,$new_password) === FALSE ){
