                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Cpurchase/insert_purchase',array('class' => 'form-vertical', 'id' => 'insert_purchase','name' => 'insert_purchase'))?>
                        ...
                        <div class="row" id="manufacturer_info">
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="manufacturer_sss" class="col-sm-4 col-form-label"><?php echo display('manufacturer')?><i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="invoice_no" class="col-sm-4 col-form-label"><?php echo display('invoice_no') ?><i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                        ...
                        <div class="row">
                              <div class="col-sm-6" id="payment_from_1">
                                <div class="form-group row">
                                    <label for="payment_type" class="col-sm-4 col-form-label"><?php echo display('payment_type'); ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                            ...
                            <table class="table table-bordered table-hover" id="purchaseTable">
                                ...
                                <tbody id="addPurchaseItem">
                                    <tr>
                                       ...
                                       <td class="wt">
                                            ...
                                            <td>
                                                <input type="text" name="discount[]" onkeyup="calculate_store(1), checkqty(1);"  onchange="calculate_store(1), checkqty(1);" id="discount_1" class="form-control text-right discount-val" min="0" tabindex="11" placeholder="0.00"/>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                           <input type="text" id="total_s" class="form-control text-right" name="total_s" value="0.00" readonly="readonly" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="text-align:right;" colspan="7"><b><?php echo '% '.display('discount_percentage') ?>:</b></td>
                                        <td class="text-right">
                                            <input type="text" id="invdcount" class="form-control text-right" name="invdcount" onkeyup="checknum(); discount_percentage();" placeholder="0.00" />
                                        </td>
                                        <td></td>
                                    </tr>
...
$(".datepicker").datepicker({ dateFormat:'yy-mm-dd' });
    ...
    function calculate_store(sl) {
        ...
        var tax_percentage    = $("#tax_percentage_" + sl).val();

        var total_price     = item_ctn_qty * vendor_rate;
        
        var taxAmount = (total_price * tax_percentage / 100);
        total_price = total_price + taxAmount;
        ...
        $(".tax_percentage").each(function () {
            if(!isNaN(this.value)){
                var total_price_amt = ($("#quantity_"+ik).val() * $("#product_rate_"+ik).val());
                if(!isNaN(total_price_amt))  
                    total_price_amt = total_price_amt - (total_price_amt * $("#discount_" + sl).val() / 100);
                    
                var tx_ammount = (total_price_amt * this.value / 100);
                if(!isNaN(tx_ammount)){
                    totalTaxAmount = totalTaxAmount + tx_ammount;   
                }
            }
            ik++;
        });
