    ...
    <section class="content"><?php
        ...
        ?><div class="row"><?php
            if($this->permission1->method('manage_customer', 'read')->access()){ 
                ?><div class="col-xs-12 col-sm-4 col-md-4 <?php if($user_type==3) echo 'col-lg-3'; else echo 'col-lg-2'; ?>">
            ...
            if($this->permission1->method('manage_mr', 'read')->access()){ 
                ?><div class="col-xs-12 col-sm-4 col-md-4 col-lg-2">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cmr/manage_mr')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_mr?></span> <span class="slight"><i class="fa fa-play fa-rotate-270 text-warning"> </i></span></h2></a>
                                <div class="small"><?php echo display('total_mr')?></div>
                                <div class="sparkline3 text-center"></div>
                            </div>
                        </div>
                    </div>
            ...
            if($this->permission1->method('manage_proforma_invoice','read')->access()) { 
                ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cproformainvoice/manage_proforma_invoice')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_proforma_invoice ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small"><?php echo display('total_proforma_invoice')?></div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cinvoice/manage_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $mr_total_sales ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small"><?php echo display('mr_total_sales')?></div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cproformainvoice/manage_proforma_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $mr_total_proforma_invoice ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small">MR Total Proforma Invoice</div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cinvoice/manage_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $customer_total_purchase ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small"><?php echo display('customer_total_purchase')?></div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cinvoice/manage_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $total_sales_amount ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small"><?php echo display('total_sales_amount')?></div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cproformainvoice/manage_proforma_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $total_proforma_invoice_amount ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small">Total Proforma Invoice Amount</div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cinvoice/manage_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $customer_total_purchase ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small"><?php echo display('total_purchase')?></div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                        <div class="panel panel-bd">
                            <div class="panel-body">
                                <div class="statistic-box">
                                    <a href="<?php echo base_url('Cproformainvoice/manage_proforma_invoice')?>" style="color:#000">
                                    <h2><small class="small">INR</small> <span class="count-number"><?php echo $customer_total_proforma_invoice ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                    <div class="small">Total Proforma Invoice Amount</div>
                                    <div class="sparkline4 text-center"></div>
                                </div>
                            </div>
            ...
            if($this->session->userdata('user_type') == '1'){
                ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cdemandrequest/manage_demandrequest')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_demand_request ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">MR Demand Request</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cdemandrequest/manage_demandrequest')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_pending_demand_request ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">MR Pending Demand Request</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cdemandrequest/manage_demandrequest')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_approve_demand_request ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">MR Approved Demand Request</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cdemandrequest/customer_demandrequest')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_cust_demand_request ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">Cust. Demand Request</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cdemandrequest/customer_demandrequest')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_cust_pending_demand_request ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">Cust. Pending Demand Request</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cdemandrequest/customer_demandrequest')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_cust_approve_demand_request ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">Cust. Approved Demand Request</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cpayments/manage_payment')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_payment_received_from_client ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">Payments Received from Client</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cmrpayments/manage_mr_payment')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_payment_received_from_mr ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">Payments Received from MR</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Csalary/manage_salary')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_salary_of_mr ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">MR Salaries</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cexpenses/manage_expenses')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_expenses_of_mr_pending ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cexpenses/manage_expenses')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_expenses_of_mr ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cexpenses/manage_expenses')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_expenses_of_mr_rejected ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box">
                                <a href="<?php echo base_url('Cmrpayments/manage_mr_payment')?>" style="color:#000">
                                <h2><span class="count-number"><?php echo $total_payment_received_from_mr ?></span><span class="slight"> <i class="fa fa-play fa-rotate-270 text-warning"> </i> </span></h2></a>
                                <div class="small">Payments Updated by Admin</div>
                                <div class="sparkline4 text-center"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box text-center">
                                <h2><span class="slight"><img src="<?php echo base_url('my-assets/image/pos_invoice.png');?>" height="40" width="40" ></span></h2>
                                <div class="small" style="font-size: 17px;margin-top: 20px;text-align: center;"><a href="<?php echo base_url('Cdemandrequest')?>"><?php echo display('add_demandrequest')?></a></div>
                            </div>
                        </div>
                    </div>
                </div><?php 
                    ...
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box text-center">
                                ...
                                <div class="small" style="font-size: 17px;margin-top: 20px;text-align: center;"><a href="<?php echo base_url('Cstockrequest')?>"><?php echo display('add_stockrequest')?></a></div>
                            </div>
                        </div>
                    </div>
                </div><?php 
            ...
            if($this->permission1->method('add_proforma_invoice','create')->access()) { 
                ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box text-center">
                                <h2><span class="slight"><img src="<?php echo base_url('my-assets/image/invoice.png');?>" height="40" width="40" > </span></h2>
                                <div class="small" style="font-size: 17px;margin-top: 20px;text-align: center;"><a href="<?php echo base_url('Cproformainvoice')?>"><?php echo display('add_proforma_invoice')?></a></div>
                            </div>
                        </div>
                    </div>
                </div><?php 
            ...
            if($this->permission1->method('add_medicine','create')->access()) { 
                ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box text-center">
                                <h2><span class="slight"><img src="<?php echo base_url('my-assets/image/product.png');?>" height="40" width="40" > </span></h2>
            ...
            if($this->permission1->method('add_customer','create')->access()) {
                ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box text-center">
                                <h2><span class="slight"><img src="<?php echo base_url('my-assets/image/customer.png');?>" height="40" width="40" > </span></h2>
                ...
                ?><div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                    <div class="panel panel-bd">
                        <div class="panel-body">
                            <div class="statistic-box text-center">
                                <h2><span class="slight"><img src="<?php echo base_url('my-assets/image/customer.png');?>" height="40" width="40" > </span></h2>
                                <div class="small" style="font-size: 17px;margin-top: 20px;text-align: center;"><a href="<?php echo base_url('Cmr')?>"><?php echo display('add_mr')?></a></div>
                            </div>
                        </div>
                    </div>
                </div><?php 
                ...
                if($this->permission1->method('monthly_progress_report','read')->access()){
                    ?><div class="panel panel-bd">
                        <div class="panel-heading">
                            <div class="panel-title"><h4><?php echo display('monthly_progress_report')?></h4></div>
                        </div>
                        <div class="panel-body"><canvas id="lineChart" height="142"></canvas></div>
                    </div><?php 
                } 
            ?></div>
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4"><?php
                if($this->permission1->method('todays_report','read')->access()){ 
                                ...
                                foreach($query as $out) {
                                    ?><tr>
                                        <td class="text-center">
                                            <a href="<?php echo base_url().'Cproduct/product_details/'.$out['product_id']; ?>"><?php echo $out['product_name']?></a>    
                                        </td>
                            ...
                            <tbody><?php
                                if($out_of_stock) {
                                    ...
                                    foreach ($out_of_stock as $stockout) { 
                                        ...
                                        ?><tr>
                                            <td class="text-center">
                                                <a href="<?php echo base_url().'Cproduct/product_details/{product_id}'; ?>"><?php echo $stockout['product_name']?></a> 
...
<script type="text/javascript">
    ...
    if(dismodl == '' && stockqt > 0 || dismodl == '' && new Date(expdate) < new Date(today)){
        $(window).load(function(){$('#stockmodal').modal('show');});
        $.ajax({ 
            type: "POST",
