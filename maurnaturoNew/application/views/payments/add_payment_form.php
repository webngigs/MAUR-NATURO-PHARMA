...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('payment') ?></h1>
        ...
        ?><div class="row">
            <div class="col-sm-12">
                <div class="column"><?php
                    if($this->permission1->method('manage_payment','read')->access()) { 
                        ?><a href="<?php echo base_url('Cpayments/manage_payment')?>" class="btn btn-info m-b-5 m-r-2">
                            <i class="ti-align-justify"> </i> <?php echo display('manage_payment')?> 
                        </a><?php 
                    } 
                ?></div>
            </div>
            ...
            ?><div class="row">
                <div class="col-sm-12">
                    <div class="panel panel-bd lobidrag">
                        ...
                        echo form_open('Cpayments/insert_payment', array('class' => 'form-vertical', 'id' => 'insert_payment'))
                            ?><div class="panel-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="customer_name" class=" form-control" placeholder='<?php echo display('customer_name').'/'.display('phone') ?>' id="customer_name" tabindex="1" onkeyup="customer_autocomplete()" value="" required  />
