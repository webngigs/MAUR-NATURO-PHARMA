...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('new_proforma_invoice') ?></h1>
            <small><?php echo display('new_proforma_invoice') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('proforma_invoice') ?></a></li>
                <li class="active"><?php echo display('new_proforma_invoice') ?></li>
            </ol>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="column"><?php
                    if($this->permission1->method('proforma_invoice','read')->access()): ?>
                        <a href="<?php echo base_url('Cproformainvoice/manage_proforma_invoice')?>" class="btn btn-info m-b-5 m-r-2">
                            <i class="ti-align-justify"> </i> 
                            <?php echo display('manage_proforma_invoice')?> 
                        </a>
                    <?php endif;?>
                </div>
            </div>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4><?php echo display('add_proforma_invoice') ?></h4>
                        </div>
                    </div>
                     <?php echo form_open_multipart('Cproformainvoice/manual_sales_insert', array('class' => 'form-vertical', 'id' => 'insert_sale', 'name' => '')) ?>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-9">
                                <div class="form-group row">
                                    <label for="customer_name" class="col-sm-12 col-form-label"><?php echo display('customer_name') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-12">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group row">
                                    <label for="date" class="col-sm-12 col-form-label"><?php echo display('date') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-12">
                                       <?php  $date = date('Y-m-d'); ?>
                                        <input class="datepicker form-control" type="text" size="50" name="invoice_date" id="date" readonly required value="<?php echo $date; ?>" tabindex="6" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered table-hover" id="normalinvoice">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"  width="100"> Quantity<i class="text-danger">*</i></th>
                                        ...
                                        <th class="text-center" width="110">G. <?php echo display('total') ?></th>
                                ...
                                <tbody id="addinvoiceItem">
                                    <tr>
                                        ...
                                        <td>
                                            <input name="" id="" class="form-control unit_1 valid" value="None" readonly="" aria-invalid="false" type="text">
                                        </td>
                                        <td>
                                        ...
                                        <!-- Discount -->
                                        <td>
                                            <input type="text" name="discount[]" onkeyup="quantity_calculate(1),checkqty(1);"  onchange="quantity_calculate(1);" id="discount_1" class="form-control text-right discount-val" min="0" tabindex="11" placeholder="0.00"/>

                                            <input type="hidden" value="" name="discount_type" id="discount_type_1">
                                            
                                            <input type="hidden" class="tax_percentage" value="" id="tax_percentage_1">
                                        </td>
                                        
                                        <td style="width: 100px" class="text-center">
                                            <strong id="item_rate_1"></strong>
                                        </td>
                                        <td style="width: 100px" class="text-center">
                                            <strong id="total_item_rate_1"></strong>
                                        </td>
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <td colspan="7" rowspan="2">
                                            <center><label style="text-align:center;" for="details" class="col-form-label"><?php echo display('proforma_invoice_details') ?></label></center>
                                            <textarea name="inva_details" class="form-control" placeholder="<?php echo display('proforma_invoice_details') ?>"></textarea>
                                        </td>
                                        <td style="text-align:right;" colspan="3"><b><?php echo display('proforma_invoice_discount') ?>:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td colspan="10"  style="text-align:right;"><b><?php echo display('total') ?> Amount:</b></td>
                                        <td class="text-right">
                                    ...
                                    <tr>
                                        <td align="center">
                                            <input type="hidden" id="cust_discout" value="0" />
                                    ...
                                    <tr style="display:none;">
                                        <td colspan="10"  style="text-align:right;"><b><?php echo display('previous'); ?>:</b></td>
                                        <td class="text-right">
    ...
    <div class="modal-content">
                ...
                <div class="panel panel-bd">
                    ...
                    <div class="panel-body">
                     <div class="col-sm-12"></div>
                      <?php echo form_open_multipart('Cproformainvoice/uploadCsv_Invoice',array('class' => 'form-vertical', 'id' => 'validate','name' => 'insert_csv_purchase'))?>
                            <div class="col-sm-12">
                                <div class="form-group row">
      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <?php echo form_open('Cproformainvoice/invoice_inserted_data_manual', array('class' => 'form-vertical', 'id' => '', 'name' => '')) ?>
...
function checkqty(sl)
{
    ...
    if(batch_id == '') {
        ...
        if(isNaN(quant)) {
            ...
            //$("#quantity_"+sl).val() = '';
            //$("#batch_id_"+sl).removeAttr('disabled');
            return false;
        }
