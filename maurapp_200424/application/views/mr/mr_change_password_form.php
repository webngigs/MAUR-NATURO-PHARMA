                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <h4>Change MR Password</h4>
                        </div>
                    </div>
                  <?php echo form_open_multipart('Cmr/mr_update_password',array('class' => 'form-vertical', 'id' => 'mr_update_password'))?>
                    <div class="panel-body">
                        <div class="form-group row">
                            <label for="customer_name" class="col-sm-3 col-form-label">Name </label>
                            <div class="col-sm-4"><label><?php echo $mr_name; ?></label></div>
                            <div class="col-sm-5"></div>
                        </div>
                        <div class="form-group row">
                            <label for="customer_name" class="col-sm-3 col-form-label">Login ID </label>
                            <div class="col-sm-4"><label><?php echo $mr_email; ?></label></div>
                            <div class="col-sm-5"></div>
                        </div>
                    	<div class="form-group row">
                    	...
                    	<div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <input class="form-control" name ="password" id="password" type="text" placeholder="<?php echo display('password') ?>"  required="required" value="" tabindex="1">
                            </div>
                            <div class="col-sm-5">
                                <input type="hidden" value="{mr_id}" name="mr_id">
                                <input type="hidden" value="{user_id}" name="user_id">
                                <input type="submit" id="add-Mr" class="btn btn-success btn-large" name="add-Mr" value="Update" tabindex="5"/>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close()?>
