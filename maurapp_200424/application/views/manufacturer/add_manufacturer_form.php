                    ...
                    <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name="pancard" id="pancard" type="text" placeholder="<?php echo display('pancard') ?>" value="" min="0" tabindex="2">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name="dl_no" id="dl_no" type="text" placeholder="<?php echo display('dl_no') ?>" value=""  min="0" tabindex="2">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input class="form-control" name="gst" id="gst" type="text" placeholder="<?php echo display('gst') ?>" value=""  min="0" tabindex="2">
                                </div>
                            </div>
