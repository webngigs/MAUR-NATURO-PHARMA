                   ...
                   <?php echo form_open_multipart('Cmanufacturer/manufacturer_update',array( 'id' => 'manufacturer_update'))?>
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" name="pancard" id="pancard" type="text" placeholder="<?php echo display('pancard') ?>" value="{pancard}" min="0" tabindex="2">
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label for="dl_no" class="col-sm-3 col-form-label"><?php echo display('dl_no') ?></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="dl_no" id="dl_no" type="text" placeholder="<?php echo display('dl_no') ?>" value="{dl_no}"  min="0" tabindex="2">
                            </div>
                        </div>
                        
                        <div class="form-group row">
                            <label for="gst" class="col-sm-3 col-form-label"><?php echo display('gst') ?></label>
                            <div class="col-sm-6">
                                <input class="form-control" name="gst" id="gst" type="text" placeholder="<?php echo display('gst') ?>" value="{gst}"  min="0" tabindex="2">
                            </div>
                        </div>
