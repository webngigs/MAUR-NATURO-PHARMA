...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo display('manage_challan') ?></h1>
            <small><?php echo display('manage_challan') ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo display('challan') ?></a></li>
                <li class="active"><?php echo display('manage_challan') ?></li>
            </ol>
        </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                if($this->permission1->method('new_challan','create')->access()){ 
                    ?><a href="<?php echo base_url('Cchallan') ?>" class="btn btn-info m-b-5 m-r-2"><i class="ti-plus"> </i> <?php echo display('new_invoice') ?> </a><?php 
                }
                ?></div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body"><?php 
                $today = date('Y-m-d'); 
                echo form_open('', array('class' => 'form-inline', 'method' => 'get')) ?>
                <div class="row">
