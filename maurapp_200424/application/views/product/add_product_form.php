                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="box_size" class="col-sm-4 col-form-label"><?php echo display('HSNCode') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="HSNCode" type="text" id="HSNCode" placeholder="<?php echo display('HSNCode') ?>" tabindex="3" min="0" required="required">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         <input class="form-control text-right" name="item_rate" type="text" onkeyup="Checkprice();" onblur="RateGSTIncluded();" required="required" id="item_rate" placeholder="0.00" tabindex="10" min="0">
                                    </div>
                                </div>
                            </div><?php 
                        $i=0;
                        foreach ($taxfield as $taxss) {?>
                            <div class="col-sm-6">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="tax<?php echo $i;?>" id="tax<?php echo $i;?>" onkeyup="Checkprice();" onblur="RateGSTIncluded();" class="form-control  text-right" value="<?php echo number_format($taxss['default_value'], 2, '.', ',');?>">
                                    </div>
                            ...
                            ?><div class="col-sm-6">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         <input class="form-control text-right" name="price" type="text" onkeyup="Checkprice()" required="required" readonly="readonly" id="price" placeholder="0.00" tabindex="10" min="0">
                                    </div>
                                </div>
                            </div>
                        </div>
