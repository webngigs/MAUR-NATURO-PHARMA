                 ...
                 <div class="panel-body">
                    <div class="row">
                            ...
                            <div class="col-sm-6">
                             ...
                             <div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input class="form-control" name="strength" type="text" id="strength" tabindex="3" placeholder="<?php echo display('strength') ?>" value="{strength}" min="0">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="box_size" class="col-sm-4 col-form-label"><?php echo display('HSNCode') ?></label>
                                    <div class="col-sm-8">
                                        <input class="form-control" name="HSNCode" type="text" id="HSNCode" placeholder="<?php echo display('HSNCode') ?>" value="{HSNCode}" tabindex="3" min="0" >
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                               <div class="form-group row">
                                    <label for="item_rate" class="col-sm-4 col-form-label">Rate GST Included <i class="text-danger">*</i> </label>
                                    <div class="col-sm-8">
                                         <input class="form-control text-right" name="item_rate" type="text" onkeyup="Checkprice();" onblur="RateGSTIncluded();" required="required" id="item_rate" placeholder="0.00"  value="{item_rate}" tabindex="10" min="0">
                                    </div>
                                </div>
                            </div><?php 
                            $i=0;
                        foreach ($taxfield as $txs) {
                                ...
                                ?>       
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                      <input type="text" name="tax<?php echo $i;?>" id="tax<?php echo $i;?>" onkeyup="Checkprice();" onblur="RateGSTIncluded();" class="form-control text-right" value="<?php echo $pr_details[0][$tax]; ?>">
                                    </div>
                            ...
                            ?><div class="col-sm-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                         <input class="form-control text-right" name="price" type="text" required="required" readonly="readonly" onkeyup="Checkprice()" placeholder="0.00" tabindex="9" min="0" value="{price}" id="price">
                                    </div>
                                </div> 
                            </div>
                        </div> 
...
<script>
function RateGSTIncluded(){
    var calc_item_rate = '0.00';
    var x = document.getElementById("item_rate").value;
    var y = document.getElementById("tax0").value;
    if(!isNaN(x) && !isNaN(y))
        calc_item_rate = parseFloat((100/(parseFloat(y)+100)) * x).toFixed(2); 
    if(!isNaN(calc_item_rate))  document.getElementById("price").value = calc_item_rate;
    else document.getElementById("price").value = calc_item_rate;
}
