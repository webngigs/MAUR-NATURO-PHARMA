            ...
            foreach($module as $key=>$value) {
                ...
                ?><div class="panel panel-bd lobidrag">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <th style="width:5%" class="text-left"><?php echo display('sl_no');?></th>
                                <th style="width:55%" class="text-left"><?php echo display('module_name');?></th>
                                <th style="width:10%" class="text-center"><?php echo display('create');?></th>
                                <th style="width:10%" class="text-center"><?php echo display('read');?></th>
                                <th style="width:10%" class="text-center"><?php echo display('update');?></th>
                                <th style="width:10%" class="text-center"><?php echo display('delete');?></th>
                            </tr>
                        </thead>
                        <tbody><?php 
                            $sl = 0;
