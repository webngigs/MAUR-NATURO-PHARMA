...
<aside class="main-sidebar">
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php
            if ($this->permission1->module('add_target')->access() || $this->permission1->module('manage_target')->access()) {
                ?><li class="treeview <?php if ($this->uri->segment('1') == ("Ctarget")) {
                    echo "active";
                } else {
                    echo " ";
                } ?>">
                                                ...
                                                if ($this->permission1->method('add_target', 'create')->access()) { ?>
                                                                                <li  class="treeview <?php if ($this->uri->segment('1') == ("Ctarget") && $this->uri->segment('2') == ("")) {
                                                                                    echo "active";
                                                                                } else {
                                                                                    echo " ";
                                                                                } ?>"><a href="<?php echo base_url('Ctarget') ?>"><?php echo display('add_target') ?></a></li>
                                                    <?php } ?>
                                                    ...
                                                    if ($this->permission1->method('manage_target', 'read')->access() || $this->permission1->method('manage_target', 'update')->access() || $this->permission1->method('manage_target', 'delete')->access()) { ?>
                                                                                    <li class="treeview <?php if ($this->uri->segment('2') == ("manage_target")) {
                                                                                        echo "active";
                                                                                    } else {
                                                                                        echo " ";
                                                                                    } ?>"><a href="<?php echo base_url('Ctarget/manage_target') ?>"><?php echo display('manage_target') ?></a></li>
                                                    <?php } ?>   
                                                </ul>
                                            </li><?php
            }
            ...
            if ($this->permission1->module('add_coupon')->access() || $this->permission1->module('manage_coupon')->access()) {
                ?><li class="treeview <?php if ($this->uri->segment('1') == ("Ccoupon")) {
                    echo "active";
                } else {
                    echo " ";
                } ?>">
