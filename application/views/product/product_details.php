    		            ...
    		            <div class="panel-body">
    						...
    						<table class="table">
    							<tr>
    								...
    								<th>Total Stock = <span style="color:#ff0000;"> {stock}</span></th>
    								<th>Total Transfer = <span style="color:#ff0000;"> {totalStockTransfer}</span></th>
    								<th>Admin Stock = <span style="color:#ff0000;"> {totalAdminStock}</span></th>
    							</tr>
    						</table>
    		            </div>
    		        </div>
    		                    ...
    		                    <table id="dataTableExample4" class="table table-bordered table-striped table-hover">
    		             			<thead>
    									<tr>
    										<th><?php echo display('date') ?></th>
    										<th>Proforma ID</th>
    										<th><?php echo display('proforma_no') ?></th>
    										<th><?php echo display('customer_name') ?></th>
    										<th><?php echo display('quantity') ?></th>
    										<th><?php echo display('rate') ?></th>
    										<th style="text-align:right;"><?php echo display('total_ammount') ?></th>
    								...
    								<tbody>
    								<?php
    									if ($salesProformaData) {
    								?>
    								{salesProformaData}
    									<tr>
    										<td>{final_date}</td>
    										<td>
    											<a href="<?php echo base_url().'Cproformainvoice/invoice_inserted_data/{invoice_id}'; ?>">
    												{invoice_id}
    											</a>
    										</td>
    											<td>
    								...
    								<tfoot>
    									<tr>
    										<td colspan="3" style="text-align:right;"><b><?php echo display('total') ?></b></td>
    										<td></td>
    										<td  style="text-align:right;">{total_proforma_sales}</td>
    										<td><b><?php echo display('grand_total') ?></b></td>
    										<td  style="text-align:right;"><b> <?php echo (($position==0)?"$currency {salesProformaTotalAmount}":"{salesProformaTotalAmount} $currency") ?></b></td>
    									</tr>
    								</tfoot>
    		                    </table>
    		                </div>
    		                    ...
    		                    <table id="dataTableExample5" class="table table-bordered table-striped table-hover">
    								...
    								{stockRequestData}
    									<tr>
    										<td>{final_date}</td>
    										<td>
    											<a href="<?php echo base_url().'Cstockrequest/stockrequests_inserted_data/{stockrequests_id}'; ?>">
    												{stockrequests_id}
    											</a>
    										</td>
    											<td>
