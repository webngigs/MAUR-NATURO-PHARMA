                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        ...
                        <div class="card-content-languages">
                            ...
                            <div class="card-content-languages-group">
                                <div>
                                    <h4><?php echo display('state_code') ?>:</h4>
                                </div>
                                <div>
                                    <ul>
                                        <li><input type="text" placeholder="<?php echo display('state_code') ?>" class="form-control" id="state_code" name="state_code" value="{state_code}" required /></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="card-content-languages-group">
